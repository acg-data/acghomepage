  ...
  ({ pageNumber, isFullscreen }, ref) => {
    ...
    return (
      ...
      >
        ...
        <img
          src={imageSrc}
          alt={`Landing page example ${pageNumber}`}
...
export function LandingFlipbook() {
  ...
  return (
    <div 
      ...
      data-testid="section-landing-flipbook"
    >
        ...
        {!isFullscreen && (
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto text-base sm:text-lg font-light">
              See examples of high-converting landing pages we've designed for startups and enterprises.
            </p>
          </div>
        )}
        ...
        {isFullscreen && (
          <div className="absolute top-4 right-4">
            <Button
              ...
              data-testid="button-landing-flipbook-close"
            >
        ...
        <div className="flex flex-col items-center">
          ...
          <div className={`flex items-center justify-center gap-2 sm:gap-3 ${isFullscreen ? 'text-white' : ''}`}>
            <Button
              ...
              data-testid="button-landing-flipbook-prev"
            >
            ...
            <Button
              ...
              data-testid="button-landing-flipbook-next"
            >
            ...
            <Button
              ...
              data-testid="button-landing-flipbook-fullscreen"
            >
          ...
          <p className={`text-xs sm:text-sm mt-4 sm:mt-5 text-center ${isFullscreen ? 'text-white/50' : 'text-slate-400'}`}>
            {isMobile ? 'Swipe or tap to flip pages' : 'Click on pages or drag to flip through examples'}
          </p>
        </div>
      </div>
    </div>
