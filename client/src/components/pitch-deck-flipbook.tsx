...
const slideLabels = [
  "Pitch Deck for AI Music SaaS Startup",
  "Pitch Deck for Food Delivery Startup",
  "Pitch Deck for Sexual Health Startup",
];
...
export function PitchDeckFlipbook() {
    ...
    <div 
      ...
      className={`transition-all duration-300 ${
        isFullscreen 
          ...
          : 'py-16 sm:py-24 bg-gradient-to-b from-aryo-offWhite to-white border-b border-aryo-lightGrey'
      }`}
      data-testid="section-pitch-deck-flipbook"
    >
      <div className={`${isFullscreen ? 'w-full max-w-6xl px-4' : 'max-w-7xl mx-auto px-6 lg:px-8'}`}>
        ...
        {isFullscreen && (
          <div className="absolute top-4 right-4">
            <Button
              ...
              data-testid="button-pitch-flipbook-close"
            >
        ...
        <div className="flex flex-col items-center">
          <div className={`mb-4 text-center px-4 ${isFullscreen ? 'text-white' : 'text-aryo-deepBlue'}`}>
            <p className="text-sm sm:text-base font-medium">
              {slideLabels[currentPage] || `Slide ${currentPage + 1}`}
            </p>
          </div>
          ...
          <div className={`flex items-center justify-center gap-2 sm:gap-3 ${isFullscreen ? 'text-white' : ''}`}>
            <Button
              ...
              data-testid="button-pitch-flipbook-prev"
            >
            ...
            <Button
              ...
              data-testid="button-pitch-flipbook-next"
            >
            ...
            <Button
              ...
              data-testid="button-pitch-flipbook-fullscreen"
            >
