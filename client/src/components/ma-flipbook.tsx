...
const PageImage = forwardRef<HTMLDivElement, { pageNumber: number; isFullscreen: boolean }>(
  ({ pageNumber, isFullscreen }, ref) => {
    ...
    const imageSrc = `/ma-deck/ma_deck_page-${paddedNumber}.png`;
    ...
    return (
      ...
      >
        ...
        <img
          src={imageSrc}
          alt={`M&A Strategy page ${pageNumber}`}
    ...
    <div 
      ...
      className={`transition-all duration-300 ${
        isFullscreen 
          ...
          : 'py-16 sm:py-24 bg-gradient-to-b from-gray-50 to-white'
      }`}
      data-testid="section-ma-flipbook"
    >
      <div className={`${isFullscreen ? 'w-full max-w-6xl px-4' : 'max-w-7xl mx-auto px-6 lg:px-8'}`}>
        {!isFullscreen && (
          <div className="text-center mb-12">
            <span className="text-xs font-bold font-sans text-[#47B5CB] tracking-[0.2em] uppercase">
              Sample Deliverable
            </span>
            <h2 className="text-3xl sm:text-4xl font-serif text-[#1a365d] mt-4 mb-4">
              M&A Strategy Deck
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto text-base sm:text-lg font-light">
              Explore a sample M&A strategy deck we've developed for clients navigating complex acquisitions.
            </p>
          </div>
        )}
        ...
        {isFullscreen && (
          <div className="absolute top-4 right-4">
            <Button
              ...
              data-testid="button-ma-flipbook-close"
            >
        ...
        <div className="flex flex-col items-center">
          ...
          <div className={`flex items-center justify-center gap-2 sm:gap-3 ${isFullscreen ? 'text-white' : ''}`}>
            <Button
              ...
              className={`transition-all ${
                isFullscreen 
                  ...
                  : 'border-gray-200 hover:border-[#274D8E] hover:bg-gray-50 disabled:opacity-40'
              }`}
              data-testid="button-ma-flipbook-prev"
            >
            ...
            <div className={`text-xs sm:text-sm font-medium px-3 sm:px-5 py-2 rounded-full min-w-[60px] sm:min-w-[80px] text-center ${
              isFullscreen 
                ...
                : 'bg-[#274D8E]/5 text-[#274D8E] border border-[#274D8E]/10'
            }`}>
            ...
            <Button
              ...
              data-testid="button-ma-flipbook-next"
            >
            ...
            <Button
              ...
              className={`hidden sm:flex transition-all ${
                isFullscreen 
                  ...
                  : 'border-gray-200 hover:border-[#274D8E] hover:bg-gray-50'
              }`}
              data-testid="button-ma-flipbook-fullscreen"
            >
          ...
          <p className={`text-xs sm:text-sm mt-4 sm:mt-5 text-center ${isFullscreen ? 'text-white/50' : 'text-slate-400'}`}>
            {isMobile ? 'Swipe or tap to flip pages' : 'Click on pages or drag to flip through the deck'}
          </p>
        </div>
      </div>
    </div>
