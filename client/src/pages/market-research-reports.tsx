    ...
    <footer className="py-16 px-4 sm:px-6 lg:px-8" style={{ background: C.primaryDeep }}>
      <div className="max-w-[1200px] mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          <a href="/privacy-policy" className="text-[12px] underline hover:text-white/60 transition-colors" style={{ color: "rgba(255,255,255,0.4)" }}>
            Privacy Policy
          </a>
          <a href="/terms-of-service" className="text-[12px] underline hover:text-white/60 transition-colors" style={{ color: "rgba(255,255,255,0.4)" }}>
            Terms of Service
          </a>
