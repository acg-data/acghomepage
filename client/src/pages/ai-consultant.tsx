  ...
  return (
    <PageLayout>
      <SEO 
        ...
        jsonLd={[
          webPageSchema({ name: "AI Consultant", description: "AI-powered strategic insights trained on proven consulting methodology.", url: "https://aryocg.com/ai-consultant" }),
          breadcrumbSchema([
            { name: "Home", url: "https://aryocg.com" },
            { name: "AI Consultant", url: "https://aryocg.com/ai-consultant" },
          ]),
        ]}
      />
