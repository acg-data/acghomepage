...
const processSteps = [
  ...
  },
  {
    number: "05",
    title: "Scale",
    description: "Optimize, monitor, and evolve your digital capabilities to stay ahead of market demands.",
  },
];
      ...
      >
        ...
        >
          ...
          {processSteps.map((step, index) => (
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 sm:p-10 border border-white/10 w-full">
