  ...
  return (
    <>
      <SEO 
        ...
        jsonLd={[
          webPageSchema({ name: "Stablecoin Savings Calculator", description: "Calculate potential savings from stablecoin adoption for your business.", url: "https://aryocg.com/tools/stablecoin-calculator" }),
          breadcrumbSchema([
